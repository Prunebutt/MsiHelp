...
\begin{flalign*}
	& \argmin_\theta \sum_{k-1}^{N} \frac{1}{\sigma_{y}^{2}} (y(k)-M(k;U+ \varepsilon_{N}^{u},x_0,p))^2 + \frac{1}{\sigma_{u}^{2}} (\varepsilon_u (k))^2 & \\
	& \argmin_{\theta} \sum_{k-1}^{N} \frac{1}{\sigma_{y}^{2}} (y(k)-M(k;\tilde U, x_0, p))^2 + \frac{1}{\sigma_{u}^{2}} (u(k)-\tilde u(k) )^2 &
  \end{flalign*}
	\\
	\hspace{-2pt}
