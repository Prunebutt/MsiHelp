...
\begin{tcolorbox}[colback=cyan!5!white,colframe=cyan!75!black,title=\textbf{Distributions}]
	\begin{flalign*}
	& \textbf{Uniform distribution:} P_y (x) = \left\{ \begin{matrix} \frac {1}{b-a} & \quad \mathrm{if} \quad x  \in  [a,b] \\ 0 & \mathrm{else} \end{matrix} \right. & \\
	& \textbf{Mean: } \mu_X = \int_{-\infty}^{\infty}{x \, p_X (x) \diff x} = \int_{a}^{b}{\frac{1}{b-a} \cdot x \diff x = \frac{a+b}{2} =: \mu_X} & \\
